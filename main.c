...
//    wprintf(L"]\n");
    ...
    uint16_t string[] = {55357, 56833, 84, 104, 105, 115, 32, 105, 115, 32, 97, 32, 116, 101, 115, 116, 55357, 56833, 55357, 56833, 64, 0};
    wprintf(L"%ls\n", createWStr(string, 21));

    uint16_t * converted = createU16(L"\U0001F601This is a test\U0001F601\U0001F601@", 19);
    for (int i = 0; i < 22; i++) {
        wprintf(L"%hu ", converted[i]);
    }
